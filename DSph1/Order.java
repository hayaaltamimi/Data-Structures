...
public class Order {
	...
	public void addId(int id){//add one product
	...
	public void setProd_Ids(String prod_Ids) { this.prod_Ids = prod_Ids; }
	public void setProductsId(LinkedList<Integer> productsId) { this.productsId = productsId; }
